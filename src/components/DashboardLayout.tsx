...
import { LayoutDashboard, ArrowLeftRight, KeyRound, BrainCircuit, LogOut, Activity } from 'lucide-react'; // <-- IMPORT ACTIVITY ICON
        ...
        <LayoutContainer>
            <Sidebar>
                ...
                <Nav>
                    ...
                    <StyledNavLink to="/monitoring"><Activity size={20} /> Monitoring</StyledNavLink> {/* <-- NEW LINK */}
